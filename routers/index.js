...
router.post('/manage/user/add', (req, res) => {
  ...
  UserModel.findOne({username})
    .then(user => {
      ...
      if (user) {
        // 返回提示错误的信息
        res.send({status: 1, msg: 'The user has existed'})
        return new Promise(() => {
        })
      } else { // 没值(不存在)
        // 保存
    ...
    .catch(error => {
      ...
      res.send({status: 1, msg: 'Register fail, please try again.'})
    })
})
...
router.post('/manage/user/update', (req, res) => {
  ...
  UserModel.findOneAndUpdate({_id: user._id}, user)
    ...
    .catch(error => {
      ...
      res.send({status: 1, msg: 'Update fail, please try again.'})
    })
})
...
router.get('/manage/user/list', (req, res) => {
  UserModel.find({username: {'$ne': 'admin'}})
    ...
    .catch(error => {
      ...
      res.send({status: 1, msg: 'Add product fail, please try again'})
    })
})
...
router.post('/manage/category/add', (req, res) => {
  ...
  CategoryModel.create({name: categoryName, parentId: parentId || '0'})
    ...
    .catch(error => {
      ...
      res.send({status: 1, msg: 'Add category fail, please try again'})
    })
})
...
router.get('/manage/category/list', (req, res) => {
  ...
  CategoryModel.find({parentId})
    ...
    .catch(error => {
      console.error('Request category list fail', error)
      res.send({status: 1, msg: 'Request category list fail, please try again'})
    })
})
...
router.post('/manage/category/update', (req, res) => {
  ...
  CategoryModel.findOneAndUpdate({_id: categoryId}, {name: categoryName})
    ...
    .catch(error => {
      console.error('Update category name fail', error)
      res.send({status: 1, msg: 'Update category name fail, please try again'})
    })
})
...
router.get('/manage/category/info', (req, res) => {
  ...
  CategoryModel.findOne({_id: categoryId})
    ...
    .catch(error => {
      console.error('Request category fail', error)
      res.send({status: 1, msg: 'Request category fail, please try again'})
    })
})
...
router.get('/manage/product/list', (req, res) => {
  ...
  ProductModel.find({})
    ...
    .catch(error => {
      console.error('Request product list fail', error)
      res.send({status: 1, msg: 'Request product list fail, please try again'})
    })
})
...
router.get('/manage/product/search', (req, res) => {
  ...
  ProductModel.find(contition)
    ...
    .catch(error => {
      console.error('Search product list fail', error)
      res.send({status: 1, msg: 'Search product list fail, please try again'})
    })
})
...
router.post('/manage/product/update', (req, res) => {
  ...
  ProductModel.findOneAndUpdate({_id: product._id}, product)
    ...
    .catch(error => {
      console.error('Update product name fail', error)
      res.send({status: 1, msg: 'Update product name fail, please try again'})
    })
})
...
router.post('/manage/product/updateStatus', (req, res) => {
  ...
  ProductModel.findOneAndUpdate({_id: productId}, {status})
    ...
    .catch(error => {
      ...
      res.send({status: 1, msg: 'Update product status fail, please try again'})
    })
})
...
router.post('/manage/role/add', (req, res) => {
  ...
  RoleModel.create({name: roleName})
    ...
    .catch(error => {
      console.error('Add Role fail', error)
      res.send({status: 1, msg: 'Add Role list, please try again'})
    })
})
...
router.get('/manage/role/list', (req, res) => {
  RoleModel.find()
    ...
    .catch(error => {
      console.error('Request Role list fail', error)
      res.send({status: 1, msg: 'Request Role list fail, please try again.'})
    })
})
